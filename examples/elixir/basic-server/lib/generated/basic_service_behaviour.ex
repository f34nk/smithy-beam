...
@moduledoc """
    Generated Elixir server behaviour for smithy.beam.demo.basic#BasicService.
"""
...
@callback handle_list_basic_items(
    term(),
    BasicServiceTypes.ListBasicItemsInput.t(),
    term()
) ::
    {:ok, BasicServiceTypes.ListBasicItemsOutput.t()} | {:error, term()}
