-module(basic_paginators_test).

-include_lib("eunit/include/eunit.hrl").
-include("basic_types.hrl").

paginate_list_basic_items_collects_all_pages_test() ->
    Config = #{base_url => <<"https://api.example">>, http_client => basic_http_mock},
    ...
    ?assertEqual(
        ...
        basic_paginators:paginate_list_basic_items(Config, Input)
    ).

paginate_list_basic_items_exports_test() ->
    Exports = basic_paginators:module_info(exports),
