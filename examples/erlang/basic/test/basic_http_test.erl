...
dispatch_builds_url_without_query_test() ->
    ...
    {ok, Resp} = basic_http:dispatch(basic_http_mock, Config, Req),
...
dispatch_propagates_client_error_test() ->
    ...
    ?assertEqual(
        {error, timeout},
        basic_http:dispatch(basic_http_mock, Config, Req)
    ).

dispatch_exports_test() ->
    Exports = basic_http:module_info(exports),
