 ...
 *
 * <p>Simple dotted member paths (for example {@code Table.TableStatus}) are emitted as snake_case
 * segment lists. JMESPath-style expressions are emitted as string literals because they cannot be
 * represented as field segment lists.
 */
