 ...
 *
 * <p>Use this for URI labels, query strings, headers, payloads, documents,
 * HTTP status codes, response headers, negotiated content types, and timestamp
 * formats derived from bindings.
 */
