...
/**
 * Language-neutral protocol hook. Implement exactly one concrete protocol first (REST JSON), then
 * register additional trait ids behind new implementations.
 */
