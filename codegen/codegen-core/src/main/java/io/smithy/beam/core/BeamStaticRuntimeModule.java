...
public record BeamStaticRuntimeModule(
  ...
  public static final BeamStaticRuntimeModule HTTP_CHECKSUM =
      module("src/http_checksum.erl", "http_checksum.erl", "http_checksum", RuntimeFeature.HTTP_CHECKSUM);

  public static final BeamStaticRuntimeModule AWS_EVENT_STREAM =
      module("src/aws_event_stream.erl", "aws_event_stream.erl", "aws_event_stream", RuntimeFeature.EVENT_STREAM);
