...
public interface BeamProtocolIntegration {
  ...
  /**
   * Module suffix for codec filenames, e.g. "open_riak_http". When empty, smithy-beam derives a
   * suffix from the trait shape name.
   */
  ...
  /**
   * True when this integration emits complete wire codecs for the protocol without a
   * BeamProtocolCodegen instance (legacy customize()-only plugins).
   */
