...
class BeamClientPaginationSupportTest {
    ...
    private static Model loadModel() {
        URL resource = BeamClientPaginationSupportTest.class
                .getResource("/model/paginated_fixture.smithy");
    ...
    void detectsPaginatedOperationsAndItemsPath() {
        ...
        OperationShape listWidgets = model.expectShape(
        ...
        PaginationInfo info = BeamClientPaginationSupport.requirePaginationInfo(
                model, service, listWidgets);
