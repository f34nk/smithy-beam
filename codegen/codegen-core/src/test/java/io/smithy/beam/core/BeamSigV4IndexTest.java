...
class BeamSigV4IndexTest {
    ...
    private static final ShapeId PING =
            ShapeId.from("smithy.beam.test.sigv4#Ping");
    private static final ShapeId UPLOAD =
            ShapeId.from("smithy.beam.test.sigv4#Upload");
