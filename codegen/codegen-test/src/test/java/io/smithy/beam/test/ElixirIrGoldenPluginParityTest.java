...
class ElixirIrGoldenPluginParityTest {

  private static Model loadModel() {
    URL resource = ElixirIrGoldenPluginParityTest.class.getResource("/model/ir_golden_http.smithy");
  ...
  private static String readGolden(String resourcePath) throws IOException {
    try (InputStream in =
        ElixirIrGoldenPluginParityTest.class.getClassLoader().getResourceAsStream(resourcePath)) {
