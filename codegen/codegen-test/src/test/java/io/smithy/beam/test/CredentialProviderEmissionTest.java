...
class CredentialProviderEmissionTest {
    ...
    void basicServiceOmitsCredentialsModule() {
        ...
        assertThat(erlang.expectFileString("runtime_http.erl"))
                .doesNotContain("_credentials:resolve");
        ...
        assertThat(elixir.expectFileString("runtime_http.ex"))
                .doesNotContain("Credentials.resolve");
    }
