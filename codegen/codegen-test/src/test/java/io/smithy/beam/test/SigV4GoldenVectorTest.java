...
class SigV4GoldenVectorTest {
    ...
    void goldenVectorMatchesExpectedSignature(String resourceName) throws IOException {
        ...
        assertThat(result.canonicalRequest()).isEqualTo(expected.expectStringMember("canonicalRequest").getValue());
        assertThat(result.stringToSign()).isEqualTo(expected.expectStringMember("stringToSign").getValue());
    ...
    void getVanillaAuthorizationHeaderUsesComputedSignature() throws IOException {
        ...
        assertThat(result.signedHeaders().get("authorization"))
                ...
                .contains("Signature=" + vector.expectObjectMember("expected").expectStringMember("signature").getValue());
    }
