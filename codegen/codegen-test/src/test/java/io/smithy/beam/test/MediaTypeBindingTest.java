...
class MediaTypeBindingTest {
  ...
  void httpPayloadMediaTypeInErlangRequestEncoder() {
    String codec =
        runErlangPlugin(loadModel()).getFileString("media_type_service_rest_json_1.erl").orElse("");
  ...
  void httpPayloadMediaTypeInElixirRequestEncoder() {
    String codec =
        runElixirPlugin(loadModel()).getFileString("media_type_service_rest_json_1.ex").orElse("");
