...
class ErlangIrGoldenPluginParityTest {

    private static Model loadModel() {
        URL resource = ErlangIrGoldenPluginParityTest.class.getResource("/model/ir_golden_http.smithy");
    ...
    @Disabled("One-time golden capture helper; run locally then copy printed paths to test/resources/golden/")
    @Test
    void captureGoldens() {
        MockManifest manifest = runClientPlugin(loadModel());
