...
class RequestCompressionEmissionTest {
  ...
  private Model compressionFixtureModel() {
    URL resource =
        RequestCompressionEmissionTest.class.getResource(
  ...
  void erlangRestJson1EmitsGzipCompressionWhenBodyExceedsMinimum() {
    ...
    String codec =
        manifest.getFileString("request_compression_rest_json_service_rest_json_1.erl").orElse("");
  ...
  void elixirRestJson1EmitsGzipCompressionWhenBodyExceedsMinimum() {
    ...
    String codec =
        manifest.getFileString("request_compression_rest_json_service_rest_json_1.ex").orElse("");
