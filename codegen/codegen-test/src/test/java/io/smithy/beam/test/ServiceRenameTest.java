...
class ServiceRenameTest {
  ...
  private static Model loadModel() {
    URL rename = ServiceRenameTest.class.getResource("/model/service_rename.smithy");
    URL shared = ServiceRenameTest.class.getResource("/model/shared_widget.smithy");
  ...
  private static ObjectNode settings() {
    return ObjectNode.builder()
        .withMember("service", "smithy.beam.test.rename#RenameService")
  ...
  void renamedShapeIdentifierMatchesBetweenTypesAndClient() {
    ...
    String types = typesManifest.getFileString("rename_service_types.hrl").orElse("");
    String codec = clientManifest.getFileString("rename_service_rest_json_1.erl").orElse("");
