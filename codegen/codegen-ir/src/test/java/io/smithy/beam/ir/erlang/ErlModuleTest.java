...
class ErlModuleTest {
  ...
  void basicServiceRestJsonLines() throws IOException {
    ...
    assertThat(module.lines())
        .isEqualTo(readExpectedLines("ir/basic_service_rest_json_1.expected.erl"));
  }
  ...
  void basicServiceRestJsonAsString() throws IOException {
    ...
    assertThat(module.asString())
        .isEqualTo(readExpectedString("ir/basic_service_rest_json_1.expected.erl"));
  }
  ...
  private static ErlFunction buildDecodeBasicItem() {
    return new ErlFunction(
        ...
        List.of(
            ...
            new ErlClause(
                List.of(new ErlAtomPattern("null")), List.of(), List.of(new ErlAtom("undefined"))),
            new ErlClause(
