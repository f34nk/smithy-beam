...
class ErlBinaryTemplateTest {
    ...
    void binaryTemplateWithBinaryTypeSpecLines() {
        ErlBinaryTemplate template = ErlBinaryTemplate.binaryTemplate(
    ...
    void binaryTemplateWithTypeSpecLines() {
        ErlBinaryTemplate template = ErlBinaryTemplate.binaryTemplate(
                ErlBinaryExpr.expr(
                        ErlCall.call("erlang", "crc32", new ErlVar("Body")),
                        "32/big-unsigned-integer"));
        assertThat(template.lines()).containsExactly("<<(erlang:crc32(Body)):32/big-unsigned-integer>>");
    }
