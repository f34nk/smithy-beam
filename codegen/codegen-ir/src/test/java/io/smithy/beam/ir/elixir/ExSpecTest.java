...
class ExSpecTest {
  ...
  void singleLineSpecLines() {
    ExSpec spec = ExSpec.functionSpec("decode_basic_item", "nil | map()", "nil | BasicItem.t()");
  ...
  void wrappedSpecAsString() {
    String longParams = "client_config(), BasicServiceTypes.GetTypeClosureInput.t()";
    String longReturn = "{:ok, BasicServiceTypes.GetTypeClosureOutput.t()} | {:error, term()}";
