...
class ElixirHostLabelIrTest {
  ...
  void hostLabelHelpersAsStringMatchesGolden() throws IOException {
    ...
    List<Function> functions = ElixirHostLabelDsl.buildHostFunctions(model, service, sp);
    assertThat(functions).hasSize(1);
    ElixirDslTestSupport.assertStructural(functions.get(0));
    assertThat(ElixirRenderer.renderFunction(functions.get(0)))
        .isEqualTo(readExpectedString("dsl/host_label_helpers.expected.ex"));
  }
