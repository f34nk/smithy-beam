...
class ElixirRestJsonIrTest {
  ...
  void decodeGetNameRequestMatchesGolden() throws IOException {
    ...
    assertThat(ElixirRenderer.renderFunction(fn))
        .isEqualTo(readExpectedString("dsl/rest_json_decode_get_name_request.expected.ex"));
  }
  ...
  void decodeGetNameResponseMatchesGolden() throws IOException {
    ...
    ElixirDslTestSupport.assertStructural(fn);
    assertThat(ElixirRenderer.renderFunction(fn))
        .isEqualTo(readExpectedString("dsl/rest_json_decode_get_name_response.expected.ex"));
  }
  ...
  void encodeGetNameRequestMatchesGolden() throws IOException {
    ...
    ElixirDslTestSupport.assertStructural(fn);
    assertThat(ElixirRenderer.renderFunction(fn))
        .isEqualTo(readExpectedString("dsl/rest_json_encode_get_name_request.expected.ex"));
  }
  ...
  void encodeGetNameResponseMatchesGolden() throws IOException {
    ...
    ElixirDslTestSupport.assertStructural(fn);
    assertThat(ElixirRenderer.renderFunction(fn))
        .isEqualTo(readExpectedString("dsl/rest_json_encode_get_name_response.expected.ex"));
  }
  ...
  void clientCodecFunctionsAreStructural() {
    ...
    for (Function fn :
        ElixirRestJsonDsl.clientCodecFunctions(
            model,
            service,
            operations,
            httpIndex,
