...
class ElixirResourceIrTest {
  ...
  void clientModuleMatchesResourceLifecycleExpectations() {
    ...
    Module module =
        ElixirResourceDsl.clientModule(ctx, organization, index, layout, delegateMod, typesMod);
  ...
  void serverModuleMatchesResourceLifecycleExpectations() {
    ...
    String typesMod = ElixirSymbolProvider.toModuleName(layout.typesModuleName());
    Module module =
        ElixirResourceDsl.serverModule(ctx, organization, index, layout, delegateMod, typesMod);
    String org = ElixirRenderer.render(module);
    assertThat(org).contains("defmodule OrganizationResource do");
