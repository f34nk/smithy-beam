...
final class ElixirAwsJsonOperationDsl {
  private ElixirAwsJsonOperationDsl() {}
  ...
  static List<Function> buildEncodeRequest(
    ...
    List<MemberShape> members = ElixirJsonCodecDsl.documentMembers(httpIndex, op, input, true);
    ...
    body.add(
        MatchExpr.bind(
            "body_map",
            ElixirJsonCodecDsl.rejectNilMapPipeline(
                "body_map",
  ...
  static List<Function> buildDecodeResponse(
    ...
    List<MemberShape> members = ElixirJsonCodecDsl.documentMembers(httpIndex, op, output, false);
    ...
    if (ElixirJsonCodecDsl.isEventStreamPayload(members, model)) {
      ...
      successBody.addAll(ElixirJsonCodecDsl.decodedBodyPrelude());
      successBody.add(
          TupleExpr.of(
              List.of(
                  AtomExpr.of("ok"),
                  StructExpr.of(
                      "Types." + outputStruct,
                      structFields(
                          ElixirJsonCodecDsl.structFieldEntriesFromDecoded(
  ...
  static List<Function> buildErrorDispatch(
    ...
    return ElixirRestJsonOperationDsl.buildErrorDispatch(model, op, sp, typesMod);
  }
