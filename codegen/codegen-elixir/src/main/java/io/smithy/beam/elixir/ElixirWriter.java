 ...
 *
 * <p>The writer accumulates a defmodule block opened by customizeBeforeShapeGeneration and closed
 * by customizeAfterIntegrations. All generate* methods append into the same open writer instance
 * via WriterDelegator.
 */
