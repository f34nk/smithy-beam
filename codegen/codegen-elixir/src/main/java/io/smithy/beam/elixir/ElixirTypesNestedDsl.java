...
import io.beam.lang.elixir.TypeDef;
...
final class ElixirTypesNestedDsl {
  private ElixirTypesNestedDsl() {}
    ...
    if (atoms.isEmpty()) {
      ...
      functions.add(
          Function.of(
              ...
              ElixirEnumHelperDsl.enumStringDecodeFallbackBody(fromFunction),
              null,
              null,
              false));
      ...
      for (int i = 0; i < members.size(); i++) {
        ...
        functions.add(
            enumOneLinerFunction(
                ...
                io.beam.lang.elixir.StringExpr.of(entry.getValue())));
      }
      functions.add(
          enumOneLinerFunction(
              toFunction,
  ...
  static TypesModule buildStructureNestedModule(
    ...
    TypeDef typeDef = ElixirBeamDslTypes.structureTypeDef("t", fieldLines);
    return ElixirBeamDslTypes.structNested(
        symbol.getName(), moduledoc, typeDef, ElixirBeamDslTypes.defstructFields(defstructFields));
  }
  ...
  static ElixirTypesEmbeddedNested buildErrorNestedModule(
    ...
    List<String> extraLines =
        new ArrayList<>(ElixirBeamDslTypes.defexceptionLines(exceptionFields));
  ...
  private static Function enumOneLinerFunction(
      String name,
      Spec specOrNull,
      List<io.beam.lang.elixir.Pattern> params,
      io.beam.lang.elixir.Expression body) {
