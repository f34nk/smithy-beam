...
import io.beam.lang.elixir.AnonFun;
import io.beam.lang.elixir.AnonFunClause;
import io.beam.lang.elixir.AssignPattern;
import io.beam.lang.elixir.AtomExpr;
import io.beam.lang.elixir.AtomPattern;
import io.beam.lang.elixir.BinaryExpr;
import io.beam.lang.elixir.BinaryPattern;
import io.beam.lang.elixir.BinarySegmentExpr;
import io.beam.lang.elixir.BinarySegmentPattern;
import io.beam.lang.elixir.CaptureExpr;
import io.beam.lang.elixir.CaseExpr;
import io.beam.lang.elixir.Clause;
import io.beam.lang.elixir.ComparisonGuard;
import io.beam.lang.elixir.ConsListPattern;
import io.beam.lang.elixir.Expression;
import io.beam.lang.elixir.Function;
import io.beam.lang.elixir.FunctionHead;
import io.beam.lang.elixir.Guard;
import io.beam.lang.elixir.IfExpr;
import io.beam.lang.elixir.InfixExpr;
import io.beam.lang.elixir.IntegerExpr;
import io.beam.lang.elixir.InterpolatedExpr;
import io.beam.lang.elixir.InterpolatedLiteral;
import io.beam.lang.elixir.InterpolatedStringExpr;
import io.beam.lang.elixir.IsTypeGuard;
...
import io.beam.lang.elixir.NilExpr;
import io.beam.lang.elixir.NilPattern;
import io.beam.lang.elixir.Pattern;
import io.beam.lang.elixir.PipeExpr;
import io.beam.lang.elixir.PipeStep;
import io.beam.lang.elixir.RemoteCallExpr;
import io.beam.lang.elixir.StringExpr;
import io.beam.lang.elixir.StringPattern;
...
final class ElixirCodecHelperDsl {
  private ElixirCodecHelperDsl() {}
