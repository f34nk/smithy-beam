 ...
 * Default {@code _types.ex} output keeps this empty. Emit lines inside {@code pushDependenciesSection}
 * with {@code writer.write} for {@code defmodule}-first files; do not prepend the container in {@link ElixirWriter#toString()}.
 */
