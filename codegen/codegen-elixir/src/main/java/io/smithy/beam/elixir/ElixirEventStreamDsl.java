...
import io.beam.lang.elixir.RaiseExpr;
...
final class ElixirEventStreamDsl {
  private ElixirEventStreamDsl() {}
  ...
  private static Function encodeEventClause(
    ...
    String tag = ElixirUnionHelperDsl.unionTagForMember(sp, member);
