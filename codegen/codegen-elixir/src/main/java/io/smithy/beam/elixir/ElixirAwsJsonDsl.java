...
final class ElixirAwsJsonDsl {
  ...
  static List<Function> sharedCodecHelpers(Model model, ServiceShape service, SymbolProvider sp) {
    return ElixirRestJsonDsl.sharedCodecHelpers(model, service, sp);
  }
  ...
  static List<Function> clientCodecFunctions(
    ...
    functions.addAll(
        clientOperationCodecFunctions(
            ...
            eventStreamModule));
    for (OperationShape op : operations) {
      functions.addAll(ElixirAwsJsonOperationDsl.buildErrorDispatch(model, op, sp, typesMod));
    }
  ...
  private static List<Function> codecHelperFunctions(
    ...
    helpers.addAll(ElixirRestJsonDsl.structureHelperFunctions(model, service, sp));
    helpers.addAll(ElixirRestJsonDsl.enumHelperFunctions(model, service, sp));
