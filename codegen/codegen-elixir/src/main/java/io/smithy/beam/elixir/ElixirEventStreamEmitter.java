...
public final class ElixirEventStreamEmitter {
    ...
    ctx.writerDelegator()
        .useFileWriter(
            ...
            writer -> {
              ...
              writer.indent();
              writer.write(
                  "@moduledoc \"Generated Amazon Event Stream helpers for $L (generated).\"",
                  service.getId());
              writer.write("");
  ...
  private static void emitUnionEventStream(
      ElixirWriter writer, Model model, UnionShape union, SymbolProvider sp, String typesMod) {
    ...
    writer.write(
        "defp encode_$L_event({:unknown, _}), do: raise ArgumentError, \"unknown event\"", helper);
    writer.write("");
  ...
  private static String decodeStructurePayload(
    ...
    StringBuilder struct =
        new StringBuilder("case Jason.decode!(")
            .append(payloadVar)
            .append(") do\n      decoded ->\n        %")
            .append(typesMod)
            .append(".")
