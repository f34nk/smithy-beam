...
public final class ElixirRuntimeTypesEmitter {
  ...
  public static void writeBody(
    ...
    ElixirFormat.writeHeredocBody(
        writer,
        java.util.List.of("Generated HTTP and client runtime types for Smithy service clients."));
    writer.closeBlock("\"\"\"");
    ...
    endpointRuleSetJson.ifPresent(
        json -> {
          ...
          writer.write("");
          ElixirFormat.writeSpec(writer, "@spec", "endpoint_rule_set", "", "endpoint_rule_set()");
