        ...
        .useFileWriter(
            ...
            writer -> {
              ...
              ElixirFormat.writeSpec(
                  ...
                  "{:ok, RuntimeTypes.HttpResponse.t()} | {:error, term()}");
              writer.write(
                  "def dispatch(http_client, config, %RuntimeTypes.HttpRequest{} = req) do");
              writer.indent();
              ...
              ElixirFormat.writeSpec(
                  ...
                  "{:ok, RuntimeTypes.HttpResponse.t()} | {:error, term()}");
              writer.write(
                  "defp dispatch_signed(http_client, config, %RuntimeTypes.HttpRequest{} = req) do");
              writer.indent();
              if (sigv4) {
              ...
              writer.write("");
              ElixirFormat.writeSpec(
                  writer, "@spec", "request", "keyword()", "{:ok, map()} | {:error, term()}");
