        ...
        .useFileWriter(
            ...
            writer -> {
              ...
              ElixirFormat.writeHeredocBody(
                  writer,
                  List.of("Generated Elixir server behaviour for " + service.getId() + "."));
              writer.closeBlock("\"\"\"");
              writer.popState();
        ...
        .useFileWriter(
            ...
            writer -> {
              ...
              BeamDocumentation.forShape(op)
                  .ifPresent(doc -> ElixirFormat.writeDocAttribute(writer, "@doc", doc));
        ...
        .useFileWriter(
            ...
            writer -> {
              ...
              ElixirFormat.writeSpec(
                  writer, "@spec", "callbacks() :: [{atom(), non_neg_integer()}]");
