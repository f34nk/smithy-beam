...
element_name({xmlElement, Name, _, _, _, _, _, _, _, _, _, _}) when is_list(Name) ->
    list_to_binary(Name);
element_name({xmlElement, Name, _, _, _, _, _, _, _, _, _, _}) when is_binary(Name) ->
    Name;
element_name({Name, _, _, _, _, _}) when is_atom(Name) ->
    list_to_binary(atom_to_list(Name));
element_name({Name, _, _, _, _, _}) when is_list(Name) ->
    list_to_binary(Name);
