...
class ErlangXmlCodecIrTest {
    ...
    void decodeSparseMapLinesMatchGolden() {
        ...
        assertThat(fn.lines()).containsExactly(
    ...
    void restXmlHelpersAsStringMatchGolden() throws IOException {
        String decode = ErlangXmlCodecIr.restXmlDecodeHelpers().stream()
                .map(ErlFunction::asString)
                .collect(java.util.stream.Collectors.joining("\n\n"));
        String encode = ErlangXmlCodecIr.restXmlEncodeHelpers().stream()
                .map(ErlFunction::asString)
                .collect(java.util.stream.Collectors.joining("\n\n"));
    ...
    private static String readExpectedString(String resourcePath) throws IOException {
        try (InputStream in = ErlangXmlCodecIrTest.class.getClassLoader().getResourceAsStream(resourcePath)) {
