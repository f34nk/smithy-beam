...
class ErlangSymbolProviderTest {
    ...
    class MemberSymbols {
        ...
        void structureMemberSymbolNameMatchesTargetType() {
            StructureShape struct = model.expectShape(
                    ShapeId.from("com.example#TestItem"), StructureShape.class);
    ...
    class ReservedWordEscaping {
        ...
        void allErlangKeywordsAreEscaped() {
            for (String keyword : List.of("after", "begin", "case", "catch", "end",
                    "fun", "if", "of", "receive", "try", "when")) {
    ...
    class NameHelpers {
        ...
        void toEnumAtomNamesReturnsLowercaseAtoms() {
            EnumShape shape = model.expectShape(
                    ShapeId.from("com.example#TestStatus"), EnumShape.class);
        ...
        void toIntEnumAtomNamesReturnsLowercaseAtoms() {
            IntEnumShape shape = model.expectShape(
                    ShapeId.from("com.example#TestPriority"), IntEnumShape.class);
    ...
    class NameDeconfliction {
        ...
        void deconflictedNamesUseSuffix() {
            ...
            Model clashModel = Model.assembler()
                    .addUnparsedModel("clash.smithy", idl)
                    .assemble()
                    .unwrap();
