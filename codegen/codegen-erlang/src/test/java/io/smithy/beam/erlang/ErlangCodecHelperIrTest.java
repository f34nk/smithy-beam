...
class ErlangCodecHelperIrTest {
    ...
    void encodeQueryValueRestJsonAsStringMatchGolden() throws IOException {
        assertGolden(ErlangCodecHelperIr.encodeQueryValueRestJson(), "ir/encode_query_value_rest_json.expected.erl");
    }
    ...
    void prefixHeadersToListAsStringMatchGolden() throws IOException {
        assertGolden(ErlangCodecHelperIr.prefixHeadersToList(), "ir/prefix_headers_to_list.expected.erl");
    }

    @Test
    void prefixHeadersFromListAsStringMatchGolden() throws IOException {
        assertGolden(ErlangCodecHelperIr.prefixHeadersFromList(), "ir/prefix_headers_from_list.expected.erl");
    }
    ...
    private static String readExpectedString(String resourcePath) throws IOException {
        try (InputStream in = ErlangCodecHelperIrTest.class.getClassLoader().getResourceAsStream(resourcePath)) {
            if (in == null) {
                return "";
            }
