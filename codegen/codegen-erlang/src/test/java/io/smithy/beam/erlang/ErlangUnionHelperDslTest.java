...
class ErlangUnionHelperIrTest {
  ...
  void unionDecodeEncodeAsStringMatchesGolden() throws IOException {
    List<Function> functions = ErlangUnionHelperDsl.unionDecodeEncode(eventUnion, provider);
    ...
    assertThat(combined)
        .isEqualTo(
            DslGoldenAssertions.readExpectedString("dsl/union_decode_encode_event.expected.erl"));
  }
