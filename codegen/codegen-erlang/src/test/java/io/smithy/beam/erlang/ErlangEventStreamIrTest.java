...
class ErlangEventStreamIrTest {
    ...
    static void setupEventStreamFixture() throws Exception {
        ...
        eventStreamUnion = model.expectShape(
                ShapeId.from("smithy.beam.test.eventstream#EventStream"),
                UnionShape.class);
    }
    ...
    void unionHelpersAsStringMatchesGolden() throws IOException {
        List<ErlFunction> functions = ErlangEventStreamIr.unionHelpers(model, eventStreamUnion, provider);
