...
class ErlangSigV4IrTest {
  ...
  void sigV4ModuleMatchesGolden() throws IOException {
    ...
    assertThat(module.asString()).isEqualTo(readExpectedString("ir/sigv4_module.expected.erl"));
  }
  ...
  private static String readExpectedString(String resourcePath) throws IOException {
    try (InputStream in =
        ErlangSigV4IrTest.class.getClassLoader().getResourceAsStream(resourcePath)) {
