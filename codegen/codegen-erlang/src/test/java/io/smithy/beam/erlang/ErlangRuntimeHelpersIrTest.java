...
class ErlangRuntimeHelpersIrTest {
    ...
    void labelParsingFunctionsMatchGolden() throws IOException {
        ...
        String combined = functions.stream()
                .map(ErlFunction::asString)
                .collect(Collectors.joining("\n\n"));
        assertThat(combined).isEqualTo(readExpectedString("ir/runtime_helpers_label_parsing.expected.erl"));
    }
    ...
    private static String readExpectedString(String resourcePath) throws IOException {
        try (InputStream in = ErlangRuntimeHelpersIrTest.class.getClassLoader().getResourceAsStream(resourcePath)) {
