...
class ErlangEnumHelperIrTest {
    ...
    static void setup() {
        ...
        Model model = Model.assembler()
                .addUnparsedModel("color.smithy", idl)
                .assemble()
                .unwrap();
        ServiceShape service = model.expectShape(ShapeId.from("com.example#ColorService"), ServiceShape.class);
        BeamSettings settings = new BeamSettings();
        settings.edition("2026");
        provider = new ErlangSymbolProvider(settings, model, service, "color_types.hrl", BeamCodegenKind.TYPES);
    ...
    void decodeColorAsStringMatchesGolden() throws IOException {
        ...
        assertThat(decode.asString()).isEqualTo(readExpectedString("ir/enum_decode_color.expected.erl"));
    }
    ...
    void encodeColorAsStringMatchesGolden() throws IOException {
        ...
        assertThat(encode.asString()).isEqualTo(readExpectedString("ir/enum_encode_color.expected.erl"));
    }
    ...
    private static String readExpectedString(String resourcePath) throws IOException {
        try (InputStream in = ErlangEnumHelperIrTest.class.getClassLoader().getResourceAsStream(resourcePath)) {
