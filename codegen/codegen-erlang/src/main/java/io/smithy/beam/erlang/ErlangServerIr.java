...
final class ErlangServerIr {
    ...
    static ErlModule serverModule(
        ...
        preamble.add(ErlComment.comment("Generated Erlang server dispatcher for " + service.getId() + "."));
        ...
        attributes.add(new ErlAttribute(
        ...
        List<ErlPreambleEntry> epilogue = List.of(
                ErlComment.comment(
                        "Call " + layout.serverModuleName() + ":init_handlers/0 during application start before dispatch."),
