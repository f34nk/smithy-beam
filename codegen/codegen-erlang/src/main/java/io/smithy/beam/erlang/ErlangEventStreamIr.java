...
final class ErlangEventStreamIr {
        ...
        return ErlFunction.function(
                ...
                List.of(ErlClause.clause(
                        ...
                        ErlList.list(
                                ...
                                ErlTuple.tuple(
                                        ErlBinary.binary(":message-type"),
                                        ErlBinary.binary("event")),
                                ErlTuple.tuple(
    ...
    static ErlFunction unionEncodeEvent(Model model, UnionShape union, SymbolProvider sp) {
        ...
        clauses.add(ErlClause.clause(
                List.of(ErlTuplePattern.tuplePattern(
                        ErlAtomPattern.atomPattern("unknown"),
                        ErlVarPattern.varPattern("_"))),
                ErlCallLocal.callLocal(
                        "error",
                        ErlTuple.tuple(
                                ErlAtom.atom("bad_event"),
                                ErlAtom.atom("unknown")))));
    ...
    static ErlFunction unionDecodeEvent(UnionShape union, SymbolProvider sp) {
        ...
        return ErlFunction.function(
                ...
                List.of(ErlClause.blockClause(
                        List.of(ErlMapPattern.mapPattern(
    ...
    static ErlFunction unionDecodeEventType(Model model, UnionShape union, SymbolProvider sp) {
        ...
        clauses.add(ErlClause.clause(
                List.of(
                        ErlVarPattern.varPattern("EventType"),
                        ErlVarPattern.varPattern("_Payload")),
                ErlCallLocal.callLocal(
                        "error",
                        ErlTuple.tuple(
                                ErlAtom.atom("bad_event"),
    ...
    private static ErlClause decodeEventTypeClause(
        ...
        return ErlClause.clause(
                List.of(
                        ErlBinaryPattern.binaryPattern(eventType),
                        ErlVarPattern.varPattern("Payload")),
                ErlTuple.tuple(
                        ErlAtom.atom(tag),
                        decodeMemberPayload(model, target, "Payload", sp)));
    }
