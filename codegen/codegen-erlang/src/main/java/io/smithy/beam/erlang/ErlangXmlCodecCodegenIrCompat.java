...
final class ErlangXmlCodecCodegenIrCompat {
  private ErlangXmlCodecCodegenIrCompat() {}
  ...
  private static ErlFunction toBinaryXmlQuery() {
  ...
  public static List<ErlFunction> restXmlEncodeHelpers() {
    return List.of(
        ...
        buildXmlChild(),
        xmlNamespaceAttrs(),
        encodeQueryValueXmlQuery(),
        toBinaryXmlQuery());
  }

  private static ErlFunction encodeQueryValueXmlQuery() {
        ...
        ErlTry.tryExpr(
            List.of(
                ...
                ErlCase.caseExpr(
                    ...
                    ErlClause.clause(List.of(ErlAtomPattern.atomPattern("false")), rootLookup))),
            List.of(
  ...
  private static ErlFunction elementContent() {
    return ErlFunction.function(
        ...
        1,
        List.of(
            ErlClause.clause(List.of(xmlElementTuple(W, 8, "Content", W)), ErlVar.var("Content")),
            ErlClause.clause(
  ...
  private static ErlFunction isElement() {
    return ErlFunction.function(
        ...
        1,
        List.of(
            ErlClause.clause(List.of(xmlElementTuple(W, -1, null, W)), ErlAtom.atom("true")),
            ErlClause.clause(
                List.of(sixTupleWithContent()),
                List.of(ErlGuard.guard("is_list", ErlVar.var("Content"))),
                ErlAtom.atom("true")),
        ...
        List.of(
            ...
            ErlClause.clause(
                ...
                ErlListComprehension.comprehensionWithFilters(
                    ...
                    ErlVar.var("Content"),
                    List.of(isListGuard(ErlVar.var("T")), notElementStringGuard(ErlVar.var("T"))))),
            ErlClause.clause(List.of(W), ErlList.list())));
  }
        ...
        List.of(
            ErlClause.clause(
                ...
                ErlCase.caseExpr(
                    ErlVar.var("T"),
                    ErlClause.clause(
                        List.of(xmlElementTuple(W, -1, null, W)), ErlAtom.atom("true")),
                    ErlClause.clause(
            ...
            ErlClause.clause(
                ...
                ErlCase.caseExpr(
                    ErlCall.call(
                        ...
                        ErlVar.var("AttrName"),
                        ErlCallLocal.callLocal(
                            "element", ErlVar.var("Element"), ErlInteger.integer(2)),
                        ErlAtom.atom("undefined")),
                    ErlClause.clause(
                        List.of(ErlAtomPattern.atomPattern("undefined")),
                        ErlAtom.atom("undefined")),
  ...
  private static ErlFunction xmlChildList() {
    ...
    ErlListComprehension nestedList =
            ...
            ErlClause.clause(
                ...
                ErlCase.caseExpr(
                    ...
                    ErlClause.clause(
                        ...
                        ErlAtom.atom("undefined")),
                    ErlClause.clause(
                        List.of(ErlVarPattern.varPattern("ListElement")), nestedList)))));
  }
        ...
        List.of(
            ErlClause.clause(
                ...
                ErlCase.caseExpr(
                    ...
                    ErlClause.clause(
                        List.of(
                            ErlTuplePattern.tuplePattern(ErlAtomPattern.atomPattern("error"), W)),
                        ErlTuple.tuple(
                            ErlAtom.atom("error"),
                            ErlTuple.tuple(
        ...
        List.of(
            ErlClause.clause(
                ...
                ErlExprBlock.block(
                    ...
                    ErlTuple.tuple(
                        ErlVar.var("Name"), ErlVar.var("Attrs"), ErlVar.var("Children")))),
            ErlClause.clause(
                List.of(
                    ErlVarPattern.varPattern("Name"),
                    ErlVarPattern.varPattern("Content"),
        ...
        List.of(
            ErlClause.clause(
                ...
                ErlTuple.tuple(
                    ...
                    ErlListComprehension.comprehension(
                        ErlCallLocal.callLocal(
                            "build_xml_element", ErlVar.var("K"), ErlVar.var("V"), ErlMap.map()),
                        ErlTuplePattern.tuplePattern(
                            ErlVarPattern.varPattern("K"), ErlVarPattern.varPattern("V")),
      ...
      return ErlFunction.function(
          ...
          List.of(
              ErlClause.clause(
                  ...
                  ErlMap.map(
                      ErlMapEntry.entry(
                          ErlAtom.atom("uri"), ErlBinary.binary(namespaceUri.get()))))));
    }
    return ErlFunction.function(
        "xml_namespace", 0, List.of(ErlClause.clause(List.of(), ErlMap.map())));
  }
