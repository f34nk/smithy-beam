...
final class ErlangClientDispatchDsl {
  private ErlangClientDispatchDsl() {}
  ...
  static List<Expression> operationBodyExprs(
      ...
      boolean paginated,
      ErlangClientDispatchOperationDsl.DispatchBodyMode mode) {
    return ErlangClientDispatchOperationDsl.buildDispatchBody(
