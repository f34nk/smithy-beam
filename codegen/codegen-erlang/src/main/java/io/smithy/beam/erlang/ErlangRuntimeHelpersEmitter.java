...
/**
 * Emits {@code runtime_helpers.erl} with HTTP path label parsing and AWS endpoint helpers. Emitted
...
public final class ErlangRuntimeHelpersEmitter {
  ...
  public static void emitIfNeeded(ErlangContext ctx, ServiceShape service) {
    ...
    boolean checksumBindings =
        ErlangHttpChecksumIr.serviceHasChecksumOperations(ctx.model(), service);
