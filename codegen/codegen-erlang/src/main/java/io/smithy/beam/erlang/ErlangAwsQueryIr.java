...
final class ErlangAwsQueryIr {
    ...
    static String clientCodecFileName(ErlangContext ctx, ServiceShape service, ShapeId protocolTraitId) {
        return layout(ctx, service).clientCodecModuleName(protocolTraitId) + ".erl";
    }

    static String serverCodecFileName(ErlangContext ctx, ServiceShape service, ShapeId protocolTraitId) {
    ...
    static void emitClientCodecModule(ErlangContext ctx, ServiceShape service, ShapeId protocolTraitId) {
