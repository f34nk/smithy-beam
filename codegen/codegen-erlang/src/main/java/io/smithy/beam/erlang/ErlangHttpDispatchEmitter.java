...
/**
 * Emits {@code runtime_http.erl} with an httpc-based HTTP dispatcher for generated clients. The
 * wrapper is thin: it converts http_request() to httpc args and wraps the response.
 */
