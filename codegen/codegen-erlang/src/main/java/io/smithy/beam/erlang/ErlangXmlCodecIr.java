                    ...
                    List.of(
                        Fun.of(
                            List.of(
                                ...
                                FunClause.of(
                                    List.of(
                                        WildcardPattern.of("K"), VariablePattern.of("V")),
                                    Variable.of("V")))),
                        Variable.of("Map"))))));
  }
        ...
        TryExpr.of(
            MatchExpr.of(
                ...
                CaseExpr.of(
                    LocalCallExpr.of(
                        "xml_element_named",
                        List.of(Variable.of("Xml"), Variable.of("RootName"))),
                    List.of(
                        Clause.of(
                            AtomPattern.of("true"),
    ...
    return Function.of("is_element_string", List.of(
            FunctionClause.of(
                ...
                CaseExpr.of(
                    ...
                    List.of(
                        Clause.of(
                            xmlElementTuple(W, -1, null, W), AtomExpr.of("true")),
                        Clause.of(
                            TuplePattern.of(
                                List.of(W, W, W, W, W, W)),
                            AtomExpr.of("true")),
                ...
                CaseExpr.of(
                    RemoteCallExpr.of(
                        ...
                        List.of(
                            ...
                            LocalCallExpr.of(
                                "element",
                                List.of(Variable.of("Element"), IntegerExpr.of(2))),
                            AtomExpr.of("undefined"))),
                    List.of(
                        Clause.of(AtomPattern.of("undefined"), AtomExpr.of("undefined")),
                        Clause.of(
                            ...
                            LocalCallExpr.of(
                                "list_to_binary", List.of(Variable.of("Value")))))))));
  }
        ...
        ListComprehensionExpr.of(
            ...
            List.of(
                ListComprehensionGenerator.of(
                    VariablePattern.of("Item"),
                    LocalCallExpr.of(
                        "element_content", List.of(Variable.of("ListElement")))),
                ListComprehensionFilter.of(
                    LocalCallExpr.of("is_element", List.of(Variable.of("Item")))),
                ListComprehensionFilter.of(
                    InfixExpr.of(
                            ...
                            TupleExpr.of(
                                List.of(
                                    LocalCallExpr.of(
                                        "xml_child_text",
                                        List.of(
                                            Variable.of("Error"), BinaryExpr.of("Code"))),
                                    LocalCallExpr.of(
                                        "xml_child_text",
                                        List.of(
                                            Variable.of("Error"),
                    ...
                    List.of(
                        Clause.of(
                            TuplePattern.of(
                                List.of(
                                    AtomPattern.of("ok"),
                                    VariablePattern.of("ErrorResponse"))),
                            errorLookup),
                        Clause.of(
        ...
        RemoteCallExpr.of(
            ...
            List.of(
                ...
                ListExpr.of(
                    List.of(
                        TupleExpr.of(
                            List.of(AtomExpr.of("prolog"), AtomExpr.of("false")))))));
    ...
    Expression body =
        MatchExpr.of(
            ListPattern.cons(
                TuplePattern.of(
                    List.of(
                        VariablePattern.of("RootName"), VariablePattern.of("Content"))),
                    ...
                    List.of(
                        ListComprehensionGenerator.of(
                            TuplePattern.of(
                                List.of(VariablePattern.of("K"), VariablePattern.of("V"))),
                            RemoteCallExpr.of(
                                "maps", "to_list", List.of(Variable.of("Value")))),
                        ListComprehensionFilter.of(
                            InfixExpr.of(
            ...
            List.of(
                ...
                ListComprehensionExpr.of(
                    LocalCallExpr.of(
                        "build_xml_element",
                        List.of(
                            BinaryExpr.of("member"), Variable.of("V"), MapExpr.of(List.of()))),
                    List.of(
                        ListComprehensionGenerator.of(
          ...
          List.of(
              FunctionClause.of(
                  ...
                  MapExpr.of(
                      List.of(
                          MapEntry.of(
                              AtomExpr.of("uri"), BinaryExpr.of(namespaceUri.get())))))));
    }
    return Function.of("xml_namespace", List.of(FunctionClause.of(List.of(), MapExpr.of(List.of()))));
  }
