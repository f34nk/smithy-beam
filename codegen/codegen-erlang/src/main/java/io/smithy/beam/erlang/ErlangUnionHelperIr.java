...
final class ErlangUnionHelperIr {
    ...
    static List<ErlFunction> unionDecodeEncode(UnionShape shape, SymbolProvider sp) {
        ...
        return List.of(
                unionDecode(shape, sp, helperName),
                unionEncode(shape, sp, helperName));
    }
    ...
    private static ErlFunction unionDecode(UnionShape shape, SymbolProvider sp, String helperName) {
        ...
        for (MemberShape member : shape.members()) {
            ...
            caseClauses.add(ErlClause.clause(
                    List.of(singletonListPattern(ErlTuplePattern.tuplePattern(
                            ErlBinaryPattern.binaryPattern(wireKey),
