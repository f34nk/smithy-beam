                ...
                List.of(
                    MapPattern.of(
                        List.of(
                            ...
                            MapPatternEntry.of(
                                AtomExpr.of("expected"), AtomPattern.of("true")))),
                    TuplePattern.of(
                    ...
                    MapPattern.of(
                        List.of(
                            MapPatternEntry.of(
                                AtomExpr.of("matcher"), AtomPattern.of("success")),
                            MapPatternEntry.of(
                                AtomExpr.of("expected"), AtomPattern.of("false")))),
                    TuplePattern.of(
            ...
            FunctionClause.of(
                List.of(
                    MapPattern.of(
                        List.of(
                            MapPatternEntry.of(
                                AtomExpr.of("matcher"), AtomPattern.of("output")),
                            MapPatternEntry.of(
                                AtomExpr.of("path"), VariablePattern.of("Path")),
                            MapPatternEntry.of(
