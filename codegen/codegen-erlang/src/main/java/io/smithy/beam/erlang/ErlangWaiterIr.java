...
final class ErlangWaiterIr {
  ...
  static ErlMap acceptorMap(BeamWaiterIndex.AcceptorInfo acceptor, SymbolProvider sp) {
    ...
    if (acceptor.successExpected().isPresent()) {
      ...
      entries.add(
          ErlMapEntry.entry(
              ErlAtom.atom("expected"), expected ? ErlAtom.atom("true") : ErlAtom.atom("false")));
      ...
      if (acceptor.resolvedError().isPresent()) {
        ...
        entries.add(ErlMapEntry.entry(ErlAtom.atom("expected"), ErlBinary.binary(errorType)));
      }
      ...
      entries.add(
          ErlMapEntry.entry(ErlAtom.atom("comparator"), ErlAtom.atom(pathMatcher.comparator())));
      entries.add(
          ErlMapEntry.entry(ErlAtom.atom("expected"), ErlBinary.binary(pathMatcher.expected())));
    } else {
      entries.add(ErlMapEntry.entry(ErlAtom.atom("matcher"), ErlAtom.atom(acceptor.matcherKind())));
    }
  ...
  static List<ErlFunction> waitUntilHelperFunctions(
    ...
    return ErlFunction.function(
        ...
        List.of(
            ErlClause.clause(
                ...
                ErlTuple.tuple(ErlAtom.atom("error"), ErlAtom.atom("max_attempts_exceeded"))),
            ErlClause.blockClause(
                List.of(
                    ErlVarPattern.varPattern("Fun"),
                    ErlVarPattern.varPattern("Acceptors"),
                ...
                ErlExprBlock.block(
                    ErlMatch.match(
                        ErlVarPattern.varPattern("Result"), ErlCallLocal.callLocal("Fun")),
                    ErlCase.caseExpr(
                        ErlCallLocal.callLocal(
                        ...
                        ErlClause.clause(
                            ...
                            ErlTuple.tuple(ErlAtom.atom("error"), ErlVar.var("Result"))),
                        ErlClause.clause(
                        ...
                        ErlClause.blockClause(
                            List.of(ErlAtomPattern.atomPattern("retry")),
                            ErlExprBlock.block(
                                ErlCall.call("timer", "sleep", ErlVar.var("Delay")),
                                ErlMatch.match(
  ...
  private static ErlFunction classify() {
    return ErlFunction.function(
        ...
        List.of(
            ErlClause.clause(
                List.of(ErlNilPattern.nilPattern(), ErlVarPattern.varPattern("_Result")),
                ErlAtom.atom("retry")),
            ErlClause.blockClause(
                List.of(
                    ErlConsPattern.consPattern(
                        ErlVarPattern.varPattern("Acceptor"), ErlVarPattern.varPattern("Rest")),
                    ErlVarPattern.varPattern("Result")),
                ErlCase.caseExpr(
                    ErlCallLocal.callLocal(
                        "matches_acceptor", ErlVar.var("Acceptor"), ErlVar.var("Result")),
                    ErlClause.clause(
                        List.of(ErlAtomPattern.atomPattern("true")),
                        ErlCall.call("maps", "get", ErlAtom.atom("state"), ErlVar.var("Acceptor"))),
                    ErlClause.clause(
        ...
        List.of(
            ErlClause.clause(
                List.of(
                    ...
                    ErlTuplePattern.tuplePattern(
                        ErlAtomPattern.atomPattern("ok"), ErlVarPattern.varPattern("_"))),
                ErlAtom.atom("true")),
            ErlClause.clause(
                List.of(
                    ErlMapPattern.mapPattern(
            ...
            ErlClause.blockClause(
                List.of(
                    ...
                    ErlTuplePattern.tuplePattern(
                        ErlAtomPattern.atomPattern("error"), ErlVarPattern.varPattern("Got"))),
                ErlCallLocal.callLocal(
                    "error_types_match", ErlVar.var("Expected"), ErlVar.var("Got"))),
            ErlClause.blockClause(
                List.of(
                    ErlMapPattern.mapPattern(
                        ErlMapFieldPattern.fieldPattern(
                            "matcher", ErlAtomPattern.atomPattern("output")),
                        ErlMapFieldPattern.fieldPattern("path", ErlVarPattern.varPattern("Path")),
                        ErlMapFieldPattern.fieldPattern(
                            "comparator", ErlAtomPattern.atomPattern("stringEquals")),
                        ErlMapFieldPattern.fieldPattern(
                            "expected", ErlVarPattern.varPattern("Expected"))),
                    ErlTuplePattern.tuplePattern(
            ...
            ErlClause.blockClause(
                ...
                ErlCallLocal.callLocal(
                    ...
                    ErlVar.var("Output"))),
            ErlClause.clause(
                List.of(ErlVarPattern.varPattern("_"), ErlVarPattern.varPattern("_")),
                ErlAtom.atom("false"))));
  }
  ...
  private static ErlFunction errorTypesMatch() {
    return ErlFunction.function(
        ...
        List.of(
            ErlClause.clause(
                List.of(ErlVarPattern.varPattern("Expected"), ErlVarPattern.varPattern("_Got")),
                List.of(ErlGuard.guard("is_binary", ErlVar.var("Expected"))),
                ErlAtom.atom("true")),
            ErlClause.clause(
                List.of(ErlVarPattern.varPattern("Expected"), ErlVarPattern.varPattern("Got")),
                List.of(
                ...
                ErlOp.op(
                    ...
                    ErlCallLocal.callLocal("element", ErlInteger.integer(1), ErlVar.var("Got")))),
            ErlClause.blockClause(
                List.of(ErlVarPattern.varPattern("Expected"), ErlVarPattern.varPattern("Got")),
  ...
  private static ErlFunction pathValue() {
    return ErlFunction.function(
        ...
        List.of(
            ErlClause.clause(
                List.of(ErlVarPattern.varPattern("Path"), ErlVarPattern.varPattern("_Value")),
                List.of(ErlGuard.guard("is_binary", ErlVar.var("Path"))),
                ErlAtom.atom("undefined")),
            ErlClause.clause(
                List.of(ErlNilPattern.nilPattern(), ErlVarPattern.varPattern("Value")),
                ErlVar.var("Value")),
            ErlClause.blockClause(
                List.of(
                    ErlConsPattern.consPattern(
                        ErlVarPattern.varPattern("Key"), ErlVarPattern.varPattern("Rest")),
            ...
            ErlClause.clause(
                List.of(ErlVarPattern.varPattern("_Path"), ErlVarPattern.varPattern("_Value")),
                ErlAtom.atom("undefined"))));
  }
  ...
  private static ErlFunction recordField() {
    return ErlFunction.function(
        ...
        List.of(
            ErlClause.blockClause(
                List.of(ErlVarPattern.varPattern("Record"), ErlVarPattern.varPattern("Field")),
                List.of(
  ...
  private static ErlFunction stringEquals() {
    return ErlFunction.function(
        ...
        List.of(
            ErlClause.blockClause(
                List.of(ErlVarPattern.varPattern("V"), ErlVarPattern.varPattern("Expected")),
                List.of(
                ...
                ErlOp.op(
                    ...
                    ErlCall.call(
                        ...
                        "uppercase",
                        ErlCallLocal.callLocal(
                            "atom_to_binary", ErlVar.var("V"), ErlAtom.atom("utf8"))),
