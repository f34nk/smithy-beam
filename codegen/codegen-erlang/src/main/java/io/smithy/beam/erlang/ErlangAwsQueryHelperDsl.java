...
final class ErlangAwsQueryHelperDsl {
  private ErlangAwsQueryHelperDsl() {}
  ...
  private static List<Function> awsQueryXmlElementHelpers() {
    return List.of(
        ErlangXmlCodecDsl.elementContentFunction(),
        awsQueryFindElement(),
        ErlangXmlCodecDsl.isElementFunction(),
        awsQueryElementName(),
        ErlangXmlCodecDsl.xmlChildTextFunction(),
        awsQueryElementText(),
        awsQueryXmlTextValues(),
        ErlangXmlCodecDsl.isElementStringFunction());
  }
  ...
  static List<Function> serverXmlEncodeHelperFunctions(boolean ec2Query) {
    ...
    functions.addAll(ErlangXmlCodecDsl.awsQueryServerEncodeHelpers());
    return functions;
  }
