...
public final class ErlangClientPaginationEmitter {
    ...
    public static void emitPaginatedOperation(
        ...
        var paginationInfo = BeamClientPaginationSupport.requirePaginationInfo(ctx.model(), service, op);
        ...
        for (ErlFunction fn : ErlangClientPaginationIr.paginatedOperationFunctions(
                ctx,
                service,
                op,
                layout,
                ...
                successReturnType,
                null)) {
            ErlangInfrastructureIr.writeFunction(writer, fn);
        }
    }
}
