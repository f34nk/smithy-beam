 ...
 *
 * <p>Implementations are discovered through {@link java.util.ServiceLoader} when registered under
 * {@code META-INF/services} for this interface. Ordering uses {@link #name}, {@link #priority},
 * {@link #runBefore}, and {@link #runAfter}. Multiple integrations must not share the same {@link
 * #name}.
 *
 * <p>Keep AWS-specific protocol traits and signing details out of unconditional generator paths.
 * Gate protocol extensions behind traits on the service or explicit integration settings via {@link
 * #configure}.
 */
public interface ErlangIntegration
    extends SmithyIntegration<BeamSettings, ErlangWriter, ErlangContext>, BeamProtocolIntegration {
