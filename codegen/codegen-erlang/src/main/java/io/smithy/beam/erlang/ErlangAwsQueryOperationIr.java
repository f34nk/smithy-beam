...
final class ErlangAwsQueryOperationIr {
      ...
      for (MemberShape member : members) {
        ...
        appendArgs.add(
            ErlCallLocal.callLocal(
                "flatten_member", ErlBinary.binary(wireKey), ErlVar.var(toBindingVar(field))));
      }
  ...
  static ErlFunction buildDecodeResponse(
    ...
    ErlRecordPattern fallbackPattern =
        ErlRecordPattern.recordPattern(
            "http_response",
    ...
    List<ErlClause> clauses =
        List.of(
            ...
            ErlClause.clause(
                ...
                ErlCallLocal.callLocal(
                    "decode_query_error", ErlVar.var("Status"), ErlVar.var("Body"))));
          ...
          ErlClause.clause(
              List.of(
                  ErlTuplePattern.tuplePattern(
                      ...
                      ErlTuplePattern.tuplePattern(
                          ErlAtomPattern.atomPattern("missing_result"), W))),
              ErlTuple.tuple(ErlAtom.atom("ok"), emptyOutput)),
          ErlClause.clause(
              List.of(
                  ErlTuplePattern.tuplePattern(
      ...
      body.add(
          ErlMatch.match(
              ...
              ErlCallLocal.callLocal(
                  ...
                  ErlMap.map(
                      ErlMapEntry.entry(
                          ErlBinary.binary(resultElement), ErlVar.var("ResultContent"))),
  ...
  static ErlFunction buildParseInputFromForm(
    ...
    for (MemberShape member : members) {
      ...
      if (target instanceof ListShape) {
        ...
        valueExpr =
            ErlCallLocal.callLocal("form_value", ErlVar.var("Params"), ErlBinary.binary(wireKey));
      }
  ...
  private static ErlRecordPattern outputBindingHead(
