...
final class ErlangXmlCodecDsl {
  private ErlangXmlCodecDsl() {}
  ...
  public static List<Function> restXmlEncodeHelpers() {
    return List.of(
        ...
        buildXmlChild(),
        xmlNamespaceAttrs(),
        ErlangCodecHelperDsl.encodeQueryValueXmlQuery(),
        ErlangCodecHelperDsl.toBinary(ErlangCodecHelperDsl.ToBinaryVariant.XML_QUERY));
  }
