...
final class ErlangClientIr {
    ...
    static List<ErlFunction> serviceFunctions(
    ...
    static ErlFunction defaultConfigFunction(
        ...
        entries.add(ErlMapEntry.entry(ErlAtom.atom("endpoint_prefix"), ErlBinary.binary(meta.endpointPrefix())));
        entries.add(ErlMapEntry.entry(ErlAtom.atom("signing_name"), ErlBinary.binary(meta.signingName())));
