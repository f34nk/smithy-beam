...
final class ErlangRestJsonOperationIr {
    ...
    private static ErlRecord buildErrorRecord(
    ...
    private static ErlCase decodeBodyJsonExpr() {
    ...
    private static ErlExpr decodeJsonExpr(
    ...
    private static ErlExpr encodeJsonExpr(
